function a_fcwml_mri_firstlevel_ROI_couple_concat_sess(SUBJNAME)
...
load batch_file_firstlevel_concat_ROI_coupling
...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).multi_reg = {fullfile(home, 'data', SUBJNAME, 'ses-day1', 'func',...
    ['sub-', SUBJNAMEcbi, '_ses-day1_task-rest_acq-normal_run-01_bold'], 'log', 'ROI_coupling',...
