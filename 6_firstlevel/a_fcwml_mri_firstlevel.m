function a_fcwml_mri_firstlevel(SUBJNAME, session, model, reg_name)
...
if session==1
    ...
    load batch_file_firstlevel_day1
...
elseif session==2
    ...
    load batch_file_firstlevel_day2
...
if session==1
    ...
    load batch_file_firstlevel_day1_UNSMOOTHED
...
elseif session==2
    ...
    load batch_file_firstlevel_day2_UNSMOOTHED
