...
class PlotCanvas(FigureCanvas):
    ...
    def __init__(self, parent=None, width=5, height=5, dpi=100):
        ...
        self.win_ave=3 # how many samples used for averaging
        self.blinkval=0
        self.smoothval=5
        self.plotsmooth=0
        self.win_lim=3 # minimum difference between eye blink events
    ...
    def get_eyeblinks(self):
        ...
        print("% of invalis samples is " + str(prop_int*100) + " %")    
