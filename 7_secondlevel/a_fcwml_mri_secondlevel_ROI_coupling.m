...
statspath=fullfile(stats_dir, 'template_1st_level_pipelines', 'smoothed', 'ROI_coupling','groupstats');
...
for c_con=1:numel(conpaths)
    ...
    load batch_second_level_ROI_coupling
...
%     end
    ...
    savedir_2ndlev = fullfile(stats_dir, 'template_2nd_level_pipelines', 'smoothed', 'ROI_coupling', conpaths(c_con).name, 'T_test');
