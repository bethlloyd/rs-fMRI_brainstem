function [con_stat] = a_extract_1stlev_con_roi(SUBJNAME, model, smoothed, pup_type)
...
statspath=fullfile(stats_dir, 'template_1st_level_pipelines', smoothed, model);
...
%roi mask file path
mask_path = fullfile(homeD, 'masks', 'ROI_final', model);
...
%% Get con stat data 
con_dir=dir(fullfile(statspath, SUBJNAME, pup_type));
con_im=dir(fullfile(statspath, SUBJNAME, pup_type,'spmT_0001.nii'));
